...
set_input_delay -max 1.87 -clock [get_clocks {clk}] [get_ports {insMemEn}]
...
set_input_delay -min 0.18 -clock [get_clocks {clk}] [get_ports {insMemEn}]
...
set_input_transition -max 0.86  [get_ports {insMemEn}]
...
set_input_transition -min 0.07  [get_ports {insMemEn}]
...
set_output_delay -max 1.0  -clock [get_clocks {clk}] [get_ports {gp[*]}]
set_output_delay -max 1.0  -clock [get_clocks {clk}] [get_ports {a7[*]}]
...
set_output_delay -min 0    -clock [get_clocks {clk}] [get_ports {gp[*]}]
set_output_delay -min 0    -clock [get_clocks {clk}] [get_ports {a7[*]}]
